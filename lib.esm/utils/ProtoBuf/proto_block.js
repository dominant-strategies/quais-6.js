...
(function (block) {
    ...
    class ProtoHeader extends pb_1.Message {
        #one_of_decls = [[2], [3], [4], [5], [6], [7], [9], [10], [14], [15], [16], [17], [18], [19], [20], [21], [22]];
        constructor(data) {
            super();
    ...
    class ProtoEtxSet extends pb_1.Message {
        ...
        get etx_set() {
            return pb_1.Message.getRepeatedWrapperField(this, ProtoEtxSetEntry, 1);
        }
        set etx_set(value) {
            pb_1.Message.setRepeatedWrapperField(this, 1, value);
        }
        ...
        toObject() {
            ...
            if (this.etx_set != null) {
                data.etx_set = this.etx_set.map((item) => item.toObject());
            }
            return data;
        }
        serialize(w) {
            ...
            if (this.etx_set.length)
                writer.writeRepeatedMessage(1, this.etx_set, (item) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes) {
    ...
    class ProtoEtxSetEntry extends pb_1.Message {
        #one_of_decls = [[1], [2], [3]];
        constructor(data) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
        ...
        get etx() {
            return pb_1.Message.getWrapperField(this, ProtoTransaction, 2);
        }
        set etx(value) {
            pb_1.Message.setOneofWrapperField(this, 2, this.#one_of_decls[1], value);
        }
    ...
    block.ProtoEtxSetEntry = ProtoEtxSetEntry;
