...
export namespace block {
    ...
    export class ProtoEtxSet extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
                if ("etx_set" in data && data.etx_set != undefined) {
                    this.etx_set = data.etx_set;
                }
            }
        }
        get etx_set() {
            return pb_1.Message.getRepeatedWrapperField(this, ProtoEtxSetEntry, 1) as ProtoEtxSetEntry[];
        }
        set etx_set(value: ProtoEtxSetEntry[]) {
            pb_1.Message.setRepeatedWrapperField(this, 1, value);
        }
        static fromObject(data: {
            etx_set?: ReturnType<typeof ProtoEtxSetEntry.prototype.toObject>[];
        }): ProtoEtxSet {
            const message = new ProtoEtxSet({});
            if (data.etx_set != null) {
                message.etx_set = data.etx_set.map(item => ProtoEtxSetEntry.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.etx_set != null) {
                data.etx_set = this.etx_set.map((item: ProtoEtxSetEntry) => item.toObject());
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.etx_set.length)
                writer.writeRepeatedMessage(1, this.etx_set, (item: ProtoEtxSetEntry) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ProtoEtxSet {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.etx_set, () => pb_1.Message.addToRepeatedWrapperField(message, 1, ProtoEtxSetEntry.deserialize(reader), ProtoEtxSetEntry));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class ProtoEtxSetEntry extends pb_1.Message {
        ...
        constructor(data?: any[] | ({} & (({
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if ("etx" in data && data.etx != undefined) {
                    this.etx = data.etx;
                }
                if ("etx_hash" in data && data.etx_hash != undefined) {
                    this.etx_hash = data.etx_hash;
        ...
        get etx() {
            return pb_1.Message.getWrapperField(this, ProtoTransaction, 2) as ProtoTransaction;
        }
        set etx(value: ProtoTransaction) {
            pb_1.Message.setOneofWrapperField(this, 2, this.#one_of_decls[1], value);
        }
        get has_etx() {
            return pb_1.Message.getField(this, 2) != null;
        ...
        static fromObject(data: {
            height?: number;
            etx?: ReturnType<typeof ProtoTransaction.prototype.toObject>;
            etx_hash?: ReturnType<typeof dependency_1.common.ProtoHash.prototype.toObject>;
        }): ProtoEtxSetEntry {
            const message = new ProtoEtxSetEntry({});
            if (data.height != null) {
                message.height = data.height;
            }
            if (data.etx != null) {
                message.etx = ProtoTransaction.fromObject(data.etx);
            }
            if (data.etx_hash != null) {
                message.etx_hash = dependency_1.common.ProtoHash.fromObject(data.etx_hash);
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.has_etx)
                writer.writeMessage(2, this.etx, () => this.etx.serialize(writer));
            if (this.has_etx_hash)
                writer.writeMessage(3, this.etx_hash, () => this.etx_hash.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ProtoEtxSetEntry {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new ProtoEtxSetEntry();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        reader.readMessage(message.etx, () => message.etx = ProtoTransaction.deserialize(reader));
                        break;
                    case 3:
                        reader.readMessage(message.etx_hash, () => message.etx_hash = dependency_1.common.ProtoHash.deserialize(reader));
                        break;
        ...
        static deserializeBinary(bytes: Uint8Array): ProtoEtxSetEntry {
            return ProtoEtxSetEntry.deserialize(bytes);
        }
    }
